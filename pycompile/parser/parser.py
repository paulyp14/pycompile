...
class Parser:
    ...
    def __init__(self,
        ...
        self.default_config = {
            ...
            'calgaryFirstAndFollow': f'{parent}/parser/grammar_files/ucalgary_first_follow.html',
            'grammar_file': f"{parent}/parser/grammar_files/LL1.paquet.grm"
        }
    ...
    def parse(self, code: str = None):
        self.success, self.ast, self.derivation = self.parser.parse(code)
